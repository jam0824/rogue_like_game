...
> 本書は「ゲーム概要_v2.md」「ダンジョン仕様_v1.md」「武器システム仕様_v1_4.md」を参照しつつ、> プレイヤーキャラクターのステータス・派生値・状態異常（スタック方式）を v1 として整理する。

- バージョン: v1.4.2  
- 更新日: 2026-02-10（player_stateの武器を正規化：weapon_def_id参照に変更）
- 参照: ゲーム概要_v2.md / ダンジョン仕様_v1.md / 武器システム仕様_v1_4.md
